...
namespace UnitTestBST
{
    ...
    public class UnitTest1
    {
        ...
        public void TryGetKeys()
        {
            ...
            var lst1 = new List<int>() { 1, 3};
            var lst2 = treeTest.Keys.ToList();

            if (lst1.Count == lst2.Count)
            {
                for (int i = 0; i < lst1.Count; i++)
                {
                    Assert.AreEqual(lst1[i], lst2[i]);
                }
            }
            else
                Assert.IsTrue(false);
        ...
        public void TryGetValues()
        {
            ...
            var lst1 = new List<int>() { 2, 4 };
            var lst2 = treeTest.Values.ToList();
        ...
        public void TryClearTree()
        {
            ...
            treeTest.Clear();
            Assert.AreEqual(0, treeTest.Keys.Count);
        }

        [TestMethod]
        [ExpectedException(typeof(InsertDuplicateKeyException))]
